...
import com.giaidoochu.activity.GameActivity;
...
public class GameGridAdapter extends BaseAdapter {
	...
	private String[][]					area;			// Tableau reprÄ‚Â©sentant les lettres du joueur
	private String[][] 					correctionArea; // Tableau reprÄ‚Â©sentant les lettres correctes
	private int[][] 					statusarea;//Cho biáº¿t Ă´ nĂ y Ä‘iá»�n chĂ­nh xĂ¡c chÆ°a?
...
//	    	if (!allTheWordPlay.contains(text)) allTheWordPlay.add(tmp.toUpperCase());
	...
	public boolean isTheSame(int x,int y,boolean horizontal){
		...
		if (horizontal){
			...
			//TÄƒng lĂªn cho Ä‘áº¿n khi gáº·p ""
			xx=x+1;
			...
			{
				//Ä�Ă¡nh dáº¥u nhá»¯ng Ă´ nĂ y Ä‘Æ°á»£c gĂ¡n cho chĂ­nh xĂ¡c vĂ  khĂ´ng cho sá»­a ná»¯a
				for(int t=x1;t<=x2;t++){
...
//		this.lastPosition = position;
    	...
    	//Náº¿u á»Ÿ cháº¿ Ä‘á»™ Ä‘Ă¡p Ă¡n Ă´ chá»¯
