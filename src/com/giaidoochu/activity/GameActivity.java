...
import com.giaidoochu.CrosswordException;
import com.giaidoochu.R;
import com.giaidoochu.SAXFileHandler;
import com.giaidoochu.keyboard.KeyboardView;
import com.giaidoochu.keyboard.KeyboardViewInterface;
import com.giaidoochu.parser.CrosswordParser;
import com.giaidoochu.parser.GridParser;
import com.giaidoochu.adapter.GameGridAdapter;
import com.giaidoochu.data.Grid;
import com.giaidoochu.data.Word;
...
public class GameActivity extends CrosswordParentActivity implements OnTouchListener, KeyboardViewInterface {
	...
	private ArrayList<View>	selectedArea = new ArrayList<View>(); // Liste des cases selectionnÄ‚Â©es

	private boolean			downIsPlayable;	// false si le joueur Ä‚Â  appuyÄ‚Â© sur une case noire 
	private int 			downPos;		// Position ou le joueur Ä‚Â  appuyÄ‚Â©
    private int 			downX;			// Ligne ou le joueur Ä‚Â  appuyÄ‚Â©
    private int 			downY;			// Colonne ou le joueur Ä‚Â  appuyÄ‚Â©
	...
	private Word			currentWord;	// Mot actuellement selectionnÄ‚Â©
	...
	public boolean onTouch(View v, MotionEvent event)
	{
        switch (event.getAction())
        {
            ...
            {
            	// Si le joueur Ä‚Â  appuyÄ‚Â© sur une case noire, aucun traitement 
...
//            	}
	...
	private void showNextLevel(CharSequence text){
		...
		//CharSequence text = "Báº¡n Ä‘Ă£ chÆ¡i xong Ă´ chá»¯ nĂ y!";
...
//			.setNegativeButton("ThoĂ¡t",new DialogInterface.OnClickListener() {
//				public void onClick(DialogInterface dialog,int id) {
//					//GameActivity.this.finish();
//			    	System.exit(0);						
//				}
