...
import com.giaidoochu.adapter.RankingAdapter;
import com.giaidoochu.parser.RankingParser;
...
public class RankingActivity extends CrosswordParentActivity{
    ...
    TextView rankpos,pointpos,ranktitle;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tusername.setTypeface(typefaceTitle);
		...
		tusername.setShadowLayer(12, -4, -4, Color.BLACK);
		...
		dialog.setMessage("Đang cập nhật! Xin chờ...");
...
//        list.setAdapter(adapter);
	...
	private void showRank(){
        ...
        if (this.username.equals("")){
        	Toast.makeText(RankingActivity.this, "Bạn chưa cập nhật điểm lên bảng xếp hạng, Hãy chơi và cập nhật!", Toast.LENGTH_SHORT).show();
        }else{
        	ranktitle.setText(String.valueOf(this.username));
        }
	...
	private class showRankFromUrlTask extends AsyncTask<String, Void, String> {    	
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
            	...
            	progressBarStatus=-1;            	
            	dialog.dismiss();
            	Toast.makeText(RankingActivity.this, "Không có wifi hoặc 3G!", Toast.LENGTH_SHORT).show();
