...
import com.giaidoochu.DownloadFilesInterface;
import com.giaidoochu.DownloadFilesTask;
import com.giaidoochu.R;
import com.giaidoochu.SAXFileHandler;
import com.giaidoochu.activity.GameActivity.GRID_MODE;
import com.giaidoochu.adapter.GridListAdapter;
...
public class GridListActivity extends CrosswordParentActivity implements OnItemClickListener, OnItemLongClickListener, DownloadFilesInterface {
	...
	private void readGridDirectory()
	{
	    ...
	    try {
	    	...
	    	if (!found){
	    		Toast.makeText(this, "Hiện chưa có ô chữ mới, xin quay lại lần sau!", Toast.LENGTH_SHORT).show();
	    	}
